...
JMM, Document generated on 05-Jun-2014 at 13:29:52.
...
```
## [1] "test.csv"                       "test_date_time_downloaded.txt" 
## [3] "train.csv"                      "train_date_time_downloaded.txt"
```
...
The test dataset provided was very limited in size (20 rows) compared to the training set (19622 rows), the test sample representing 0.001% of the total number of samples.
